...
<div style="padding: 10px 0 50px 0; text-align: center;"><span style="font-size: 14px;"><a style="background: #555555; color: #fff; padding: 12px 30px; text-decoration: none; border-radius: 3px; letter-spacing: 0.3px;" href="{account_activation_link}">E-Mail bestätigen</a></span></div>
</div>
